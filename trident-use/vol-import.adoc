...
TIP: Um ein durch die NetApp Cloud Volumes Service in AWS gesicherte Volume zu importieren, muss das Volume anstelle seines Namens anhand seines Volume-Pfads identifiziert werden.
