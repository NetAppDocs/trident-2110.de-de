...
| trident.netapp.io/cloneFromPVC | KlonSourceVolume | ontap-nas, ontap-san, solidfire-san, aws-cvs, Azure-netapp-Files, gcp-cvs, ontap-san-Economy 
...
| Snapshots | bool | Richtig, falsch | Pool unterstützt Volumes mit Snapshots | Volume mit aktivierten Snapshots | ontap-nas, ontap-san, solidfire-san, aws-cvs, gcp-cvs 


| Klone | bool | Richtig, falsch | Pool unterstützt das Klonen von Volumes | Volume mit aktivierten Klonen | ontap-nas, ontap-san, solidfire-san, aws-cvs, gcp-cvs 
...
| Fstype | Zeichenfolge | Ext4, ext3, xfs usw. | Der Filesystem-Typ für Block-Volumes | solidfire-san, ontap-san, ontap-san-Economy, Eseries-iscsi | Alle 
|===
...
| KlonSourceVolume | Zeichenfolge | Nein | ONTAP (nas, san) & SolidFire-* & aws-cvs*: Name des zu klonenden Volumes 
